...
// components
import PatrolTable from "utilities/UIToolbox/IVSSDetail/PatrolTable";
import MediaList from "utilities/UIToolbox/IVSSDetail/MediaList";
      ...
      >
        ...
        >
          <Tab
            ...
            label={<p style={{ marginTop: 15, color: "white" }}>STATUS</p>}
          />
          <Tab
            style={{ minWidth: 100, outline: "none" }}
