    ...
    <Container maxWidth="xl">
      <Grid container justify="center" spacing={5}>
        <Grid item md={3} xs={12}>
          <Menu1 handleSlideIndex={handleSlideIndex} />
        </Grid>
        <Grid item md={3} xs={12}>
          <Menu2 handleSlideIndex={handleSlideIndex} />
        </Grid>
        <Grid item md={3} xs={12}>
          <Menu3 handleSlideIndex={handleSlideIndex} />
        </Grid>
        <Grid item md={3} xs={12}>
          <Menu4 handleSlideIndex={handleSlideIndex} />
        </Grid>
      </Grid>
    </Container>
  );
